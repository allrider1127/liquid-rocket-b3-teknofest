...
# Jet A-1 is a kerosene-based aviation fuel. 
# Typical surrogate properties used in NASA CEA: C12H23
# Approximate enthalpy of formation: ~ -6000 cal/mol
# Nominal density: ~ 0.804 g/cc
custom_fuel_card = """
fuel Jet_A1  C 12.0 H 23.0  wt%=100.0  h,cal=-6000.0  t(k)=298.15  rho=0.804
"""
add_new_fuel('Jet_A1', custom_fuel_card)
...
C = CEA_Obj( oxName='GOX', fuelName='Jet_A1', 
             pressure_units='bar', 
             cstar_units='m/s', 
             temperature_units='K', 
             isp_units='sec',
...
print("Propellants: Gaseous Oxygen (GOX) / Jet A-1 (Surrogate C12H23)")
