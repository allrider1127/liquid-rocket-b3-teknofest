...
# D-Limonene properties based on provided details and thermochemical data
# Chemical Formula: C10H16
# Enthalpy of formulation: ~ -54.5 kJ/mol -> -13,030 cal/mol
# Density: 0.8411 g/cc
custom_fuel_card = """
fuel D_Limonene  C 10.0 H 16.0  wt%=100.0  h,cal=-13030.0  t(k)=298.15  rho=0.8411
"""
add_new_fuel('D_Limonene', custom_fuel_card)
...
C = CEA_Obj( oxName='GOX', fuelName='D_Limonene', 
             pressure_units='bar', 
             cstar_units='m/s', 
             temperature_units='K', 
             isp_units='sec',
...
print("Propellants: Gaseous Oxygen (GOX) / D-Limonene (C10H16)")
